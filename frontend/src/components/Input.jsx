      ...
      try {
        ...
        try {
          ...
          if (response.ok) {
            ...
            // Update analysis result with API data
            analysisResult = {
              ...analysisResult,
              apiData: result,
              source: 'api'
            ...
            if (result) {
              ...
              analysisResult.status = apiStatus;
              console.log("API analysis status:", apiStatus);
            }
          } else {
            ...
            analysisResult.error = `API Error: ${response.status} - ${errorText}`;
          }
        } catch (apiError) {
          console.log("API error:", apiError.message, "- using fallback analysis");
          analysisResult.error = `Network Error: ${apiError.message}`;
        }

        // Navigate to score page with the result data
        navigate('/analyze/score', { 
